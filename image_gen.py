# -*- coding: utf-8 -*-
"""
Created on Tue Mar 22 21:05:46 2022
...
label =  input("ENTER LABEL FOR THE SIGN YOU WANT TO TRAIN: ")
...
#print(images[0][0], images[0].shape)



for x in images:
    df.loc[len(df.index)] = [alphabet.find(label)]+x.tolist()[0]


df.to_csv('{}.csv'.format(label), index = False)
